...
(function () {
  ...
  const VERSION = '1.0.0';
  const WEBHOOK_DEFAULT = 'https://getgarsen.app.n8n.cloud/webhook-test/decidento';
  ...
  // ── Extract company data from the page header ──
    ...
    contactBlocs.forEach((bloc) => {
      ...
      btn.addEventListener('click', (e) => {
        ...
        document.querySelectorAll('.formaxe-form-container.formaxe-visible').forEach(f => {
          if (f !== miniForm) f.classList.remove('formaxe-visible');
        });
